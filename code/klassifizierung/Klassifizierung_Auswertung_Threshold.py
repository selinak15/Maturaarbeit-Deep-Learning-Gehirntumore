# ============================================
# BRAIN TUMOR CLASSIFICATION EVALUATION – 1. Try 
# ============================================
#import all libaries 
...
# Sklearn Metriken (Auswertungsmetriken)
...
print(f"\n Hardware: {'GPU (' + torch.cuda.get_device_name(0) + ')' if device == 0 else 'CPU'}")
...
def parse_tumor_filename(filename):
    ...
    if 'glioma' in basename.lower():
        ...
        return 'pituitary'
    elif 'notumor' in basename.lower() or 'no_tumor' in basename.lower():
        return 'notumor'
...
print("\n🔍 Suche Bilder...")
base_path = '/content/drive/My Drive/Testing_1/Testing'
...
print("\n🚀 Starte Klassifikation mit Label-Standardisierung...")
