"""
============================================
RGB SEGMENTATION VISUALIZATION  Pixeldarstellung 
...
CONFIG = {
    # Paths
    'data_dir': '/content/drive/My Drive/Testing_Segmentation',
    ...
    'tumor_class': 1,   # Filter by class: 1, 2, 3, or None for any
