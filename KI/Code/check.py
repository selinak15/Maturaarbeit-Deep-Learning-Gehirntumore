...
CONFIG = {
    'input_dir': '/content/drive/My Drive/Testing_Segmentation/first',
    ...
    try:
        ...
        with h5py.File(mat_path, 'r') as f:
            ...
            if label_int in CONFIG['label_mapping']:
                ...
                print(f"   ⚠️ Unbekanntes Label {label_int} in {filename}")
...
print("\n💡 NÄCHSTE SCHRITTE:")
print("1. Überprüfe Label-Mapping in CONFIG['label_mapping']")
print("2. Falls Labels falsch: Ändere das Mapping und führe erneut aus")
print("3. Verwende diese Bilder für deine Evaluierung mit code_ma.py")
print(f"4. Ändere base_path in code_ma.py zu: '{CONFIG['output_dir']}'")
